...
<html lang="en">
  ...
  <body id="page-top">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 mb-5 mb-lg-0">
            ...
            <a class="btn btn-outline-light btn-social mx-1" href="{{$linkedin}}" target="blank"><i class="fab fa-fw fa-linkedin"></i></a>
            <a class="btn btn-outline-light btn-social mx-1" href="{{$github}}" target="blank"><i class="fab fa-fw fa-github-square"></i></a>
          </div>
          <!-- Footer About Text-->
          <div class="col-lg-4">
    ...
    <!-- Partner Modals-->
     ...
     @foreach($partner as $item)
    <!-- Partner Modal {{$i}}-->
    <div class="portfolio-modal modal fade" id="portfolioModal{{$i++}}" tabindex="-1" aria-labelledby="portfolioModal1{{$i}}" aria-hidden="true">
